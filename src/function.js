...
function Chart(id,{type,width,height,margin,padding=0,data,options}){
    ...
    if (type==="bar"){
      ...
      // width, height 조정 필요
      const chart = new BarChart({chart_area,labels,datasets:datasets,color,width:chart_width,height:chart_height,margin,padding,scales});
      chart.tooltip();
      chart.animation();
