<template>
  <div style="display: flex; flex-direction: row; justify-content: space-between;">
    <div class="card mb-4" style="position: static; width: 600px;">
      <div class="card-body bg-primary text-white ">Radar Chart </div>
        <p class="m-3"> Radar 차트 데이터 형식</p>
        <div class="row" style="margin-bottom: 5px;">
          <div class="col-sm-6">
              &nbsp;&nbsp;&nbsp; <input class="form-check-input" type="radio" name="radarFormat" value="1" checked style="margin: 5px; margin-top: 5px;"/>poly
          </div>
          <div class="col-sm-6">
              <input class="form-check-input" type="radio" name="radarFormat" value="2" style="margin: 5px; margin-top: 5px;"/>circle
          </div>
        </div> 
...
export default {
  ...
  methods: {
    generate: function () {
      ...
      //data 갱신
      var chartFormat = (document.getElementsByName("radarFormat")[0].checked)? true : false;
...
<style>
  @import "/node_modules/ssart/src/css/index.css";
</style>