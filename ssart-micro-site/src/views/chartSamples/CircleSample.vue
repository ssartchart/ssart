    ...
    <div class="card mb-4" style="position: static; width: 600px;">
      <div class="card-body bg-primary text-white ">Bar Chart </div>
        ...
        <div class="row" style="margin-bottom: 5px;">
          ...
          <div class="col-sm-6">
              <input class="form-check-input" type="radio" name="circleFormat" value="2" style="margin: 5px; margin-top: 5px;"/>Pie
          </div>
        </div> 
  ...
  methods: {
    generate: function () {
      const data = {
          ...
          datasets: [{    
              data : [
              { name : '', value: 100, backgroundColor: '#ff0000' },
              { name:'', value: 200, backgroundColor: '#ff0000' },
              { name: '', value: 300, backgroundColor: '#ff0000' },
      ...
      //data 갱신
      var chartFormat = (document.getElementsByName("circleFormat")[0].checked)? "donut" : "pie";
      ...
      data.datasets[0].data[0].backgroundColor=colorHex[Color1];
      data.datasets[0].data[1].backgroundColor=colorHex[Color2];
      data.datasets[0].data[2].backgroundColor=colorHex[Color3];
